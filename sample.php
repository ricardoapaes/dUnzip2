...
echo ($d['external_attributes1'] & 1) ? 'File is read only.' : 'File is NOT read-only.';
echo '<br>';
echo ($d['external_attributes1'] & 2) ? 'File is hidden.' : 'File is NOT hidden.';
echo '<br>';
echo ($d['external_attributes1'] & 4) ? 'File is system.' : 'File is NOT system.';
echo '<br>';
echo ($d['external_attributes1'] & 16) ? "It's directory." : "It's NOT a directory.";
echo '<br>';
echo ($d['external_attributes1'] & 32) ? 'File is archive' : 'File is NOT archive';
echo '<br>';
